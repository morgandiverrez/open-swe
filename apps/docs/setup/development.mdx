...
3. **Install the GitHub App**: Go to Settings and install the GitHub App on your repositories
...
- **[GitHub Integration](/labs/swe/setup/github-integration)** - Learn how to connect your GitHub account and select repositories
- **[Authentication](/labs/swe/setup/authentication)** - Understand how the authentication system works
- **[Usage](/labs/swe/usage/intro)** - Start using Open SWE for code changes
- **[Monorepo Structure](/labs/swe/setup/monorepo)** - Learn about the development best practices
