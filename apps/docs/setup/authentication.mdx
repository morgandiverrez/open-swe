...
<Note>
  For a user-friendly guide on connecting your GitHub account and selecting repositories, see the [GitHub Integration](/labs/swe/setup/github-integration) guide. This page focuses on the technical implementation details.
</Note>
